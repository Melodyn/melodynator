...
const createDomRefs = (): t.domRefs => {
  ...
  return <t.domRefs><unknown>{
    ...
    elSetIntervalSteps,
    elScaleConfigSettingsButton: createFakeElement(),
    ...
    getElPresetScaleCardHeader: () => <HTMLDivElement><unknown>createFakeElement(),
    ...
    getElPresetFretboardCardHeader: () => <HTMLDivElement><unknown>createFakeElement(),
    getElScaleConfigSettingsElements: () => <t.scaleConfigSettingsElements><unknown>{
      elIntervalDisplaySwitch: createFakeElement(),
      elEnharmonicSimplifySwitch: createFakeElement(),
      elIntervalDisplayLabel: createFakeElement(),
      elEnharmonicSimplifyLabel: createFakeElement(),
    },
